...
BJHud.MaxOxygen = 25.00 --must be a float, preferrably 100.0 or below. 100 even feels superhuman. 25.00 feels about right and rounds nicely.
...
BJHud.MinimumStress = 50
BJHud.MinimumSpeed = 150 --mph at which player will accumulate stress, every 30 secs

BJHud.EffectInterval = {
    [1] = {
        min = 50,
        max = 60,
